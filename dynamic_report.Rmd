...
Over several days we collected data based on the ads we received on Youtube. The data was collected on Google Form and was analysed further.
...
paste("The longest ad is", 
      ...
      "sec.")
```
## What If youtube updates their ads?
This was asked to see how if they update their ad library. It was also asked to see how heavily they were influenced by age, demographic, or gender 
```{r}
...
However, we saw that most of the ads we saw were new. This suggest that they do not heavily personalise who they show their ads to.
...
The bar graph above showed that as the ad is shorter than 15sec it tends to be not skippable. However if it is longer than 15s they are skippable. If the ad was exactly 15sec, the ad was evenly likely to be skippable or not skippable
