...
ggsave("BG1.png", plot = BG1, width = 3, height = 3)

BG2 <- ggplot(data = latest_data) +
  geom_bar(aes(x = Ad_length),
           fill = "#ADD8E6") +
  labs(title = "What are the lengths of the ads?",
       subtitle = "Bar chart showing ad length in sample(Stats220P2)",
       caption = "Source: Youtube",
       x = "Ad length(sec)",
       y = "Percentage")

ggsave("BG2.png", plot = BG2, width = 3, height = 3)
...
ggsave("BG3.png", plot = BG3, width = 3, height = 3)
