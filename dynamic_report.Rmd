...
ggsave("BG1.png", plot = BG1, width = 1, height = 1)
...
ggsave("BG2.png", plot = BG2, width = 1, height = 1)
...
ggsave("BG3.png", plot = BG3, width = 1, height = 1)
...
my_animated_meme <- frames <- c(frame2, frame3)

image_animate(frames, fps = 3)
